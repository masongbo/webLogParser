...
import com.itM.bigdata.weblog.mrbean.WebLogBean;
...
public class ClickStreamPageView extends Configured implements Tool {
	...
	/*	String inputPath="hdfs://hadoop100:8020/weblog/"+DateUtil.getYestDate()+"/weblogPreOut";
		String outputPath="hdfs://hadoop100:8020/weblog/"+DateUtil.getYestDate()+"/pageViewOut";
        ...
        job.setInputFormatClass(TextInputFormat.class);
        job.setOutputFormatClass(TextOutputFormat.class);
        TextInputFormat.addInputPath(job, new Path("file:///D:\\itM\\bigdata\\日志文件数据\\weblogPreOut2"));
        TextOutputFormat.setOutputPath(job, new Path("file:///D:\\itM\\bigdata\\日志文件数据\\pageViewOut2"));
