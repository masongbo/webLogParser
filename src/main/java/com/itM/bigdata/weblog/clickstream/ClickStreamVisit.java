package com.itM.bigdata.weblog.clickstream;

import com.itM.bigdata.weblog.mrbean.PageViewsBean;
import com.itM.bigdata.weblog.mrbean.VisitBean;
...
public class ClickStreamVisit extends Configured implements Tool {
	...
	/*	String inputPath = "hdfs://hadoop100:8020/weblog/"+ DateUtil.getYestDate() + "/pageViewOut";
		String outPutPath="hdfs://hadoop100:8020/weblog/"+ DateUtil.getYestDate() + "/clickStreamVisit";
		FileSystem fileSystem = FileSystem.get(new URI("hdfs://hadoop100:8020"),conf);
        ...
        job.setInputFormatClass(TextInputFormat.class);
        job.setOutputFormatClass(TextOutputFormat.class);
        TextInputFormat.addInputPath(job, new Path("file:///D:\\itM\\bigdata\\日志文件数据\\pageViewOut2"));
        TextOutputFormat.setOutputPath(job, new Path("file:///D:\\itM\\bigdata\\日志文件数据\\clickStreamVisit2"));
