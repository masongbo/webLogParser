package com.itM.bigdata.weblog.pre;
...
public class WebLogParser {
    ...
    public static WebLogBean parser(String line) {
        ...
        //222.66.59.174 - - [18/Sep/2017:06:53:30 +0000] "GET /images/my.jpg HTTP/1.1" 200 19939 "http://www.angularjs.cn/A00n" "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:23.0) Gecko/20100101 Firefox/23.0"
        String[] arr = line.split(" ");
        if (arr.length > 11) {
            webLogBean.setRemote_addr(arr[0]);
            webLogBean.setRemote_user(arr[1]);
            //将我们的字符串转换成中文习惯的字符串
            //  [18/Sep/2017:06:52:32 +0000]
            ...
            //58.215.204.118 - - [18/Sep/2017:06:52:33 +0000] "-" 400 0 "-" "-"
