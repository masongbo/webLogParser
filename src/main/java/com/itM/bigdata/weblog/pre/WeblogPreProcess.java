...
import com.itM.bigdata.weblog.utils.DateUtil;
...
*/
        FileInputFormat.addInputPath(job,new Path("file:///D:\\itM\\bigdata\\日志文件数据\\input"));
        job.setInputFormatClass(TextInputFormat.class);
        FileOutputFormat.setOutputPath(job,new Path("file:///D:\\itM\\bigdata\\日志文件数据\\weblogPreOut2"));
        job.setOutputFormatClass(TextOutputFormat.class);
